...
cmd({
    ...
    try {
        await reply("🔍 Checking for KAVIYA-MD updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your KAVIYA-MDbot is already up-to-date!");
        }

        await reply("🚀 Updating KAVIYA-MD Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/KAVIYA-MD/KAVIYA-MD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "KAVIYA--MD-main");

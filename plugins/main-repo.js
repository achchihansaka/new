...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/KAVIYA-MD/KAVIYA-MD';
    ...
    try {
        ...
        const style1 = `╭───『 KAVIYA-MD REPO 』───⳹
│
│ 📦 *Repository*:KAVIYA-MD.git
│ 👑 *Owner*:KAVIYA-MD
│ ⑂ *Forks*: 29
│ 🔗 *URL*: http//ssjskskwoO/KAVIYA-MD.git
│
│ 📝 *Description*:
│ KAVIYA-MD
│
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'KAVIYA-MD',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
